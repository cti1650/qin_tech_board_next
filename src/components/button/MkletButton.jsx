  ...
  return (
    <>
      <div className="w-full flex justify-center items-center">
        ...
        <div
          className="dark:bg-gray-800 bg-gray-50 hover:shadow-inner hover:bg-gray-300 rounded-lg outline-none border dark:border-gray-600 border-gray-400 px-2 py-1 shadow-lg dark:text-white text-black hover:text-black"
        >
