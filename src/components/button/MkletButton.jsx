  ...
  return (
    <>
      <div className="w-full flex justify-center items-center">
        <div className="text-white">ブックマークバーへドラッグ⇒</div>
        <div
          className="bg-gray-800 hover:shadow-inner hover:bg-gray-300 rounded-lg outline-none border border-gray-600 px-2 py-1 shadow-lg text-white hover:text-black"
        >
