  ...
  return (
    <>
      <a href={url} target="_blank" rel={noRef}>
        <div className="h-full dark:bg-gray-800 bg-gray-50 hover:shadow-inner hover:bg-gray-300 rounded-lg outline-none border border-gray-600 px-3 py-1.5 shadow-lg dark:text-white text-black hover:text-black">
